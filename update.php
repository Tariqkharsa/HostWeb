...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($artName_err) && empty($arti_err) && empty($dep_err)){
        ...
        $sql = "UPDATE ARTPIECES SET ANAME=?, ARTIST=?, ARTINFO=?, DEPTNAME=? WHERE AID=?";
         
        if($stmt = mysqli_prepare($connect, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssssi", $param_artName, $param_arti, $param_info, $param_dep, $param_id);
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="dep" class="form-control <?php echo (!empty($dep_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $dep; ?>">
